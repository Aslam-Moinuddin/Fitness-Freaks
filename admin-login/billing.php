...
if (isset($_POST["search"])) {
    $SUBtype = $_POST["sub"];
    $query1 = "SELECT * FROM member WHERE subscription='$SUBtype'";
    $result1 = mysqli_query($con, $query1);
    $query2 = "SELECT price FROM subscription WHERE name='$SUBtype'";
    $result2 = mysqli_query($con, $query2);
    if ($result2) {
        $subscriptionData = mysqli_fetch_assoc($result2);
...
<body>
    ...
    <div class="form-container">
        ...
        <?php if (isset($result1) && $result1 && mysqli_num_rows($result1) > 0) : ?>
            <div class="container">
                <h2> Available Member Details</h2>
                <div class="row">
                            ...
                            <table class="table table-bordered">
                                ...
                                <?php while ($row = mysqli_fetch_assoc($result1)) : ?>
                                    <tr>
                                        ...
                                        <td><a href="payment.php?name=<?php echo $row['name']; ?>&subscription=<?php echo $row['subscription']; ?>&price=<?php echo $price; ?>" class="btn btn-pencil" style="color:blue;">Charge Payment</a></td>
                                    </tr>
                                <?php endwhile; ?>
                            </table>
                        </div>
